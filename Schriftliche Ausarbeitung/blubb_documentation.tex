...
\newcommand{\beap}{beap}
\newdate{startdate}{15}{04}{2014}
\newdate{enddate}{15}{08}{2014}
...
\end{itemize}
The start date for the project was  \displaydate{startdate} and \displaydate{enddate} is the delivery date of the implemented app.
...
\begin{figure}[!ht]
	...
	\floatfoot{Source: 	\citep{smartphoneShare}}
\end{figure}
...
\includepdf[pages={1,2},scale=1]{Anfrage_BenniRichter.pdf}
